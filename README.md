...
> หมายเหตุ: บัตรคิวแบบ `appointment_list` จะใช้ข้อความ "เวลานัดเป็นเวลาโดยประมาณ\nกรุณามาล่วงหน้าและเตรียมรอคิว\nเนื่องจากมีผู้ใช้บริการจำนวนมาก" เป็นค่าเริ่มต้น ส่วนคิวรูปแบบ "ทั่วไป" จะใช้ข้อความ "กรุณารอเรียกคิวจากเจ้าหน้าที่" หากต้องการเปลี่ยนแปลงสามารถกำหนดค่า "หมายเหตุเพิ่มเติม (Bixolon)" ในการตั้งค่าระบบได้
