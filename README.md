...
| --- | --- | --- |
| `QUEUE_PRINTER_INTERFACE` | *(จำเป็น)* | URI การเชื่อมต่อเครื่องพิมพ์ เช่น `tcp://192.168.0.50:9100` |
...
ต้องการใช้ร่วมกับหน้า Kiosk ที่มีอยู่ เพียงเปิดใช้งานการพิมพ์แบบ BIXOLON แล้วตั้งค่า `bixolon_service_url` ให้ชี้มายังบริการนี้ (เช่น `http://127.0.0.1:18080`) ก็จะสามารถสั่งพิมพ์ผ่าน `node-thermal-printer` ได้ทันที
