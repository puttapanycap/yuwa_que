            ...
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link" href="queue_management.php">
                            <i class="fas fa-tasks"></i>จัดการคิว
                        </a>
                        <a class="nav-link" href="settings.php">
                            <i class="fas fa-cog"></i>การตั้งค่า
                        </a>
                        <a class="nav-link" href="auto_reset_settings.php">
                            <i class="fas fa-clock"></i>Auto Reset
                        </a>
                        <a class="nav-link active" href="auto_reset_logs.php">
                            <i class="fas fa-history"></i>ประวัติ Auto Reset
                        </a>
